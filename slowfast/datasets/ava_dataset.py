...
class Ava(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Since the image path videos start with image 1 and seq starts with 0
        # we achieve mostly symmetric sampling of images around center_idx (which is not necessarily included)
